var DatatablesRendererExport = require('md_insert_table/static/js/datatables-renderer.js');
...
exports.getLineHTMLForExport = function (hook, context) {
  if (context.text.indexOf('data-tables') != -1) {
    ...
    if (attribIndex) {
      ...
      context.lineContent = DatatablesRendererExport.DatatablesRenderer.render(
        'export',
        context,
        dtAttrs,
      );
